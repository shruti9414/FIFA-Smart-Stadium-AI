...
export default function EnhancedProgressTimeline({
  ...
  const labels = [
    { full: "Boot", short: "Boot" },
    { full: "Crowd", short: "Crowd" },
    { full: "Medical", short: "Med" },
    { full: "AI Analysis", short: "AI" },
    { full: "Transport", short: "Trn" },
    { full: "Goal", short: "Goal" },
    { full: "Resolution", short: "Res" },
    { full: "Sustainability", short: "Sust" },
  ...
  return (
    <motion.div
      ...
      className="fixed top-20 left-4 sm:left-6 right-4 sm:right-auto sm:max-w-2xl z-30 hidden lg:block"
    >
      <div className="backdrop-blur-xl bg-slate-900/50 border border-cyan-500/20 rounded-lg p-4">
        ...
        <p className="text-xs font-mono text-cyan-400/60 uppercase tracking-widest mb-4">
          ▸ Mission Progress — {currentStepIndex !== null ? currentStepIndex + 1 : 0} / {steps.length}
        </p>
        ...
        <div className="flex flex-col gap-4">
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Label Below Icon */}
                  <motion.p
                    className={`text-xs text-center font-mono font-semibold whitespace-nowrap transition-colors duration-300 ${
                      isCompleted
                        ? "text-green-400"
                        : isCurrent
                          ? "text-cyan-300"
                  ...
                  {idx < steps.length - 1 && (
                    <motion.div
                      className="w-6 h-0.5 flex-shrink-0 relative -mt-1"
                      animate={{
          ...
          {/* Legend */}
          <div className="flex gap-4 pt-2 border-t border-cyan-500/10 text-xs text-slate-400">
